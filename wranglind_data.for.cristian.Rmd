...
#Discriminatory dose boscalid
    ...
    boscalid.data.cristian <-read.csv("data/Boscalid.Cristian.csv")
  ...
  ## Mexico and Brazil
    ...
    boscalid.data.MX.BZ <-read.csv("data/DD_survey-WMNCSRP_boscalid.Brazilian.Mexican.csv")
      boscalid.data.MX.BZ <- boscalid.data.MX.BZ %>%
      select(
      ID,
      repeats,
      experimental_replicate,
     ...
     #Discriminatory dose picoxystrobin
      ...
      picoxystrobin.data.cristian <-
        ...
        picoxystrobin.data.MX.BZ <-
        read.csv("data/DD_survey-WMNCSRP_picoxystrobin.Mexican.Brazilian.csv")
        picoxystrobin.data.MX.BZ <- picoxystrobin.data.MX.BZ %>%
        select(
        ID,
        repeats,
        experimental_replicate,
     ...
     #Discriminatory dose tetraconazole
        ...
        tetraconazole.data.cristian <-
          ...
          new)
           ...
           tetraconazole.data.MX.BZ <-
          read.csv("data/DD_survey-WMNCSRP_tetraconazole.Mexican.Brazilian.csv")
          tetraconazole.data.MX.BZ<- tetraconazole.data.MX.BZ %>%
          select(
          ID,
          repeats,
          experimental_replicate,
