...
# select(ID, repeats, experimental_replicate, control.ecuatorial_30hr, control.polar_30hr, boscalid.ecuatorial.30hr, boscalid.polar_30hr) %>% 
      ...
      mutate(
        ...
        control.growth.boscalid.36hrs = ((
        control.boscalid.ecuatorial.36hrs + control.boscalid.polar.36hrs
        ) / 2),
        boscalid.growth.36hrs = ((
        boscalid.ecuatorial.36hrs + boscalid.polar.36hrs
        ) / 2),
   ...
   survey.data.Cristian.drybeans.boscalid <-  survey.data.Cristian.drybeans %>% 
     select(ID,
          ...
          boscalid.growth,
          control.growth.boscalid,
          #boscalid.growth.36hrs,# taking out this for a meantime
          #control.growth.boscalid.36hrs,# taking out this for a meantime
          new) %>% 
