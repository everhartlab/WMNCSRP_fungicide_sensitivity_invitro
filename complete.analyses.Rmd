...
#   top_n(1, EC50DC) %>% #keeping the highest value of each ID value
  ...
  myplot_model_1 <- function(filename, RG, logEC50, lm)  { 
    data <- filename
    RG <- data$RG
...
myplot_model_1(boscalid.joined.2.clean, lm = boscalid.lm) #+ scale_y_continuous(breaks = c(-3,-2.75,-2.5,-2.25,-2.0,-1.75,-1.5))
...
myplot_model_1(tetraconazole.joined.2.clean, lm = tetraconazole.lm) 
...
myplot_model_1(picoxystrobin.joined.2.clean, lm = picoxystrobin.lm) 
...
#data
a.tet <- myplot_model_1(tetraconazole.joined.2.clean, lm = tetraconazole.lm) + theme(plot.margin = unit(c(1,1,1,1),"cm"))+   theme(axis.text.x=element_blank(), axis.title = element_blank(), axis.title.y = element_blank(), legend.position = "none")
a.tet

b.bos <- myplot_model_1(boscalid.joined.2.clean, lm = boscalid.lm)+  theme(plot.margin = unit(c(-0.5,1,1,1),"cm")) +   theme(axis.text.x=element_blank(), axis.title.x = element_blank(), legend.position = "none")
b.bos

c.pico <- myplot_model_1(picoxystrobin.joined.2.clean, lm = picoxystrobin.lm) + theme(plot.margin = unit(c(-0.5,1,1,1),"cm")) +   theme(axis.title.y = element_blank(), legend.position = "none")
c.pico
...
aa.tet <-myplot_model_2(tetraconazole.EC50DC)+ expand_limits(x = c(0.27, 1.8), y = c(0.27, 1.8))  + scale_x_continuous(name = waiver(),
                                                                             breaks = c(0.3, 0.6, 0.9, 1.2, 1.5,1.8)) + scale_y_continuous(breaks = c(0.3, 0.6, 0.9, 1.2, 1.5,1.8))+ theme(plot.margin = unit(c(1,1,1,1),"cm"))+   theme( axis.title = element_blank(), axis.title.y = element_blank(), legend.position = "none")+ geom_label(aes(x = 1.5,
                  y = 0.6)
              ,
              label = c(paste  (
                " Y =",
...
bb.bos <-myplot_model_2(boscalid.EC50DC)+ expand_limits(x = c(0.04, 0.25), y = c(0.04, 0.25))  + scale_x_continuous(name = waiver(),
                                                                             breaks = c(0.05, 0.1, 0.15, 0.20, 0.25)) + scale_y_continuous(breaks = c(0.05, 0.1, 0.15, 0.20, 0.25))+  theme(plot.margin = unit(c(-0.7,1,1,1),"cm")) +   theme( axis.title.x   = element_blank(), legend.position = "none") + geom_label(aes(x = 0.20,
                                                    y = 0.10)
                                                ,
                                                label = c(paste  (
                                                  " Y =",
...
cc.pico<- myplot_model_2(picoxystrobin.EC50DC)+ expand_limits(x = c(0.005, 0.018), y = c(0.005, 0.018))  + scale_x_continuous(name = waiver(),
                                                                             breaks = c(0.0075, 0.01, 0.0125, 0.0150, 0.018)) + scale_y_continuous(breaks = c(0.0075, 0.01, 0.0125, 0.0150, 0.018))  +   theme(plot.margin = unit(c(-0.6,1,1,1),"cm")) + theme(axis.title.y = element_blank(), legend.position = "none") + geom_label(aes(x = 0.015,
                  y = 0.009)
              ,
              label = c(paste  (
                " Y =",
