...
#data
a <- myplot_model_1(tetraconazole.joined.2.clean) + theme(plot.margin = unit(c(1,1,1,1),"cm"))+   theme(axis.text.x=element_blank(), axis.title = element_blank(), axis.title.y = element_blank(), legend.position = "none")

b <- myplot_model_1(boscalid.joined.2.clean)+  theme(plot.margin = unit(c(-0.5,1,1,1),"cm")) +   theme(axis.text.x=element_blank(), axis.title.x = element_blank(), legend.position = "none")

c <- myplot_model_1(picoxystrobin.joined.2.clean) + theme(plot.margin = unit(c(-0.5,1,1,1),"cm")) +   theme(axis.title.y = element_blank(), legend.position = "none")
...
aa <-myplot_model_2(tetraconazole.EC50DC)+ expand_limits(x = c(0.27, 1.8), y = c(0.27, 1.8))  + scale_x_continuous(name = waiver(),
                                                                             breaks = c(0.3, 0.6, 0.9, 1.2, 1.5,1.8)) + scale_y_continuous(breaks = c(0.3, 0.6, 0.9, 1.2, 1.5,1.8))+ theme(plot.margin = unit(c(1,1,1,1),"cm"))+   theme( axis.title = element_blank(), axis.title.y = element_blank(), legend.position = "none")




bb <-myplot_model_2(boscalid.EC50DC)+ expand_limits(x = c(0.04, 0.25), y = c(0.04, 0.25))  + scale_x_continuous(name = waiver(),
                                                                             breaks = c(0.05, 0.1, 0.15, 0.20, 0.25)) + scale_y_continuous(breaks = c(0.05, 0.1, 0.15, 0.20, 0.25))+  theme(plot.margin = unit(c(-0.7,1,1,1),"cm")) +   theme( axis.title.x   = element_blank(), legend.position = "none")



cc<- myplot_model_2(picoxystrobin.EC50DC)+ expand_limits(x = c(0.005, 0.018), y = c(0.005, 0.018))  + scale_x_continuous(name = waiver(),
                                                                             breaks = c(0.0075, 0.01, 0.0125, 0.0150, 0.018)) + scale_y_continuous(breaks = c(0.0075, 0.01, 0.0125, 0.0150, 0.018))  +   theme(plot.margin = unit(c(-0.6,1,1,1),"cm")) + theme(axis.title.y = element_blank(), legend.position = "none")



#Myplot <- multiplot(aa,bb,cc, cols=1)
ggarrange(aa,bb,cc, ncol = 1, labels = c("A", "B", "C"))

####

aaa <- myplot_comparison(survey.tetraconazole.fields.2, highlabel = 0.1)  + expand_limits(y = c(0.5, 1.6)) + scale_y_continuous(breaks = c(0.4, 0.6, 0.8, 1, 1.2, 1.4, 1.6))+ theme(plot.margin = unit(c(1,1,1,1),"cm"))+   theme( axis.title = element_blank(), axis.title.y = element_blank(), legend.position = "none")


bbb <- myplot_comparison(survey.boscalid.fields.2,highlabel = 0.01) + expand_limits(y = c(0.06, 0.18)) +
  scale_y_continuous(breaks = c(0.06, 0.08, 0.1, 0.12, 0.14, 0.16, 0.18)) + geom_hline(yintercept =
...
ccc <- myplot_comparison(survey.picoxystrobin.fields.2,highlabel = 0.005)  + scale_y_continuous(breaks = c(0.008, 0.01, 0.012, 0.014, 0.016, 0.018, 0.020, 0.022, 0.024)) + geom_hline(yintercept =
                                                                                                                                                       0.02148932, linetype = "dashed")  +   theme(plot.margin = unit(c(-0.7,1,1,1),"cm")) + theme(axis.title.y = element_blank(), legend.position = "none")

 ggarrange(aaa,bbb,ccc, ncol = 1, labels = c("A", "B", "C"))
```
