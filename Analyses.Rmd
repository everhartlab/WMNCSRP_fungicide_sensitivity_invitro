...
kruskal.test(Estimate.50DC ~ group, data = data_for_plots_bos_2)

#There is difference p-value = 0.0001098
...
kruskal.test(Estimate.50DC ~ group, data = data_for_plots_pico_2)

#There is NO difference p-value = 0.29
...
kruskal.test(Estimate.50DC ~ group, data = data_for_plots_tetra_2)

#There is NO difference p-value = 0.5193
