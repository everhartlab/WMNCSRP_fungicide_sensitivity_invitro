...
TRUE ~ NA_real_), # I used this "NA_real_" instead of "NA" becasue Iam getting this error: must be a double vector, not a logical vector
pico= case_when(
...
TRUE ~ NA_real_)) %>%
  # Filering by solo group that is current season
