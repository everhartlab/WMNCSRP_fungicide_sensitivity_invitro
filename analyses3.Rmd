---
title: "Survey fungicide sensitivity of S. sclerotiorum from drybean and soybean from the U.S."
output:
  html_document:
    df_print: paged
    toc: TRUE
...
object.1 <- kruskal.test(EC50DC ~ Origin, data = boscalid.complete)

#There is difference p-value = 1.25 *10 -05

object.2 <-  DunnTest(EC50DC ~ Origin, data = boscalid.complete, method = "bonferroni")
...
#
SUMMARY.final_data_isolates <- final_data_isolates %>% 
  group_by(Group) %>% 
