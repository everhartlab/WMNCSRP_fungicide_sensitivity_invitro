...
fig.1.boscalid <-
  ...
  panel.background = element_rect(fill = "white", colour = "grey50")
              ...
              "Relative growth (%)", y = "Log EC50") + expand_limits(x = c(15, 65)) + scale_x_continuous(name = waiver(), breaks = c(15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65)) 
...
fig.1.tetraconazole <-
  ...
  "Relative growth (%)", y = expression(Log ~ EC[50])) + expand_limits(x = c(15, 65)) + scale_x_continuous(
  breaks = c(15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65)) +  theme(
  plot.title = element_text(
  size = 8,
  face = "bold",
  hjust = 0.5,
