...
fig.1.boscalid <-
  ...
  ) + geom_smooth(method = "lm", se = FALSE) +  theme(
  plot.title = element_text(
  size = 8,
  face = "bold",
  hjust = 0.5,
  ...
  panel.background = element_rect(fill = "white", colour = "grey50")
              ...
              "Relative growth (%)", y = "Log EC50") + expand_limits(x = c(23, 50)) + scale_x_continuous(name = waiver(), breaks = c(25, 30, 35, 40, 45, 50)) 
...
fig.1.picoxystrobin <-
  ...
  panel.background = element_rect(fill = "white", colour = "grey50")
              ...
              "Relative growth (%)", y = "Log EC50") + expand_limits(x = c(38, 65)) + scale_x_continuous(name = waiver(), breaks = c(40, 45, 50, 55, 60, 65)) 
...
##
picoxystrobin.complete.fields$Field <- factor(picoxystrobin.complete.fields$Field, c("Mexico_Brazil","MI_Montcalm_2015", "WI_Hancock", "MI:East_Lansing", "MI_Montcalm_2017", "IA_Nashua", "WI_Cerny",  "Baseline"))
...
fig.1.tetraconazole <-
  ...
  panel.background = element_rect(fill = "white", colour = "grey50")
              ...
              "Relative growth (%)", y = "Log EC50") +  expand_limits(x = c(15, 45)) + scale_x_continuous(name = waiver(), breaks = c(15, 20, 25, 30, 35, 40, 45))
...
##
tetraconazole.complete.fields$Field <- factor(tetraconazole.complete.fields$Field, c("NE:Field34","NE:Field_67","NE:Field_101","NE:Field_98", "NE:Field_97", "Baseline", "NE:Field_75", "Mexico_Brazil", "NE:Holt"))
