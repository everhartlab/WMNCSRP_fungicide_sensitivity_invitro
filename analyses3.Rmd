...
expression(bold(EC[bold("50")])~( bold(ppm ~bold("a.i.")))), y = expression(bold(EC[bold("50")~(bold("D"))])~( bold(ppm ~bold("a.i.")))))+ geom_abline(
 ...
 fig.2.boscalid
  ...
  ggplot(final.boscalid.DC.two, aes(x = Estimate.50, y = Estimate.50DC)) +  geom_point(aes(shape= Host, colour = source),
     size = 2,
     alpha = 3 / 4
...
ggplot(final.picoxystrobin.DC.two, aes(x = Estimate.50, y = Estimate.50DC)) +  geom_point(aes(shape= Host, colour = source),
     size = 2,
     alpha = 3 / 4
      ) + geom_smooth(method = "lm", se = FALSE, color = "black"
  #fullrange=TRUE                
...
ggplot(final.tetraconazole.DC.two, aes(x = Estimate.50, y = Estimate.50DC)) +  geom_point(aes(shape= Host, colour = source),
     size = 2,
     alpha = 3 / 4
      )      + geom_smooth(method = "lm",se= FALSE, color= "black") +  theme(
plot.title = element_text(
