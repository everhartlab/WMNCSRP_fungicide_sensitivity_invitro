...
#  Analysis  of Boscalid fungicide
## Serial dilution
...
```{r Calculus of DC Boscalid, echo = FALSE}
...
# Using the function fo dtect oulires from serial dilution grouping by origin using the model of 2.5 ppm
