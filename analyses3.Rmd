...
summary(aov (EC50DC ~ Field, data = picoxystrobin.complete.fields))
model <- lm(EC50DC ~ Field, data = picoxystrobin.complete.fields)
ANOVA <- aov(model)
tukey.test <- TukeyHSD(ANOVA)
tukey.test.2 <- HSD.test(ANOVA, trt = 'Field')
...
object.17 <- DunnTest(EC50DC ~ Field, data = tetraconazole.complete.fields, method = "bonferroni")
object.17
...
summary(aov (EC50DC ~ Field, data = tetraconazole.complete.fields))
