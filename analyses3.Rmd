...
expression(bold(EC[bold("50")])~( bold(ppm))), y = expression(bold(EC[bold("50")~(bold("D"))])~( bold(ppm))))+ geom_abline(
                intercept = final.boscalid.DC.0.2[[1]][[1]],
                slope = 1,
                color = "black",
                lty = "dashed",
                lwd = 1
...
expression(bold(EC[bold("50")])~( bold(ppm))), y = expression(bold(EC[bold("50")~(bold("D"))])~( bold(ppm)))) + geom_abline(
                intercept =final.picoxystrobin.DC.0.01 [[1]][[1]],
                slope = 1,
                color = "black",
                lty = "dashed",
                lwd = 1
 ) + expand_limits(x = c(0.0075, 0.018), y = c(0.0075, 0.016)) + scale_x_continuous(name = waiver(),
...
expression(bold(EC[bold("50")])~( bold(ppm))), y = expression(bold(EC[bold("50")~(bold("D"))])~( bold(ppm)))) + geom_abline(
                intercept = final.tetraconazole.DC.2[[1]][[1]],
                slope = 1,
                color = "black",
                lty = "dashed",
                lwd = 1
