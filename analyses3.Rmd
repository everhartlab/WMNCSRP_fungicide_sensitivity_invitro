...
expression(bold(EC[bold("50")])~( bold(ppm ~bold("a.i.")))), y = expression(bold(EC[bold("50")~(bold("D"))])~( bold(ppm ~bold("a.i.")))))+ geom_abline(
                ...
                lty = "dashed",
                lwd = 1
                ) +  expand_limits(x = c(0, 0.25), y= c(0, 0.25))+ scale_x_continuous(name = waiver(), breaks = c(0, 0.05, 0.1, 0.15, 0.20, 0.25)) + scale_y_continuous(breaks = c(0, 0.05, 0.1, 0.15, 0.20, 0.25))
...
fig.3.boscalid <- boscalid.complete.fields%>%
  ...
  theme_minimal() +
  labs(x = "Field", y = expression(bold(EC[bold("50")~(bold("D"))])~( bold(ppm)))) + theme(
  panel.border = element_rect(
  colour = "black",
  fill = NA,
  size = 1
...
expression(bold(EC[bold("50")])~( bold(ppm))), y = expression(bold(EC[bold("50")~(bold("D"))])~( bold(ppm)))) + geom_abline(
                intercept = 0,
                slope = 1,
                color = "black",
                lty = "dashed",
                lwd = 1
 ) + expand_limits(x = c(0, 0.0075, 0.018), y = c(0, 0.0075, 0.018)) + scale_x_continuous(name = waiver(),
breaks = c(0.0025,0.0050,0.0075, 0.01, 0.0125, 0.015,  0.018)) + scale_y_continuous(name = waiver(),
breaks = c(0.0025,0.0050,0.0075, 0.01, 0.0125, 0.015,  0.018))
...
fig.3.picoxystrobin <-picoxystrobin.complete.fields%>%
  ...
  theme_minimal() +
  labs(x = "Field", y = expression(bold(EC[bold("50")~(bold("D"))])~( bold(ppm)))) +
  theme(
  panel.border = element_rect(
  colour = "black",
  fill = NA,
  ...
  panel.background = element_rect(fill = "white", colour = "grey50") ) + scale_y_continuous(breaks = c(0.008, 0.01, 0.012, 0.014, 0.016, 0.018, 0.020,0.022,0.024))
...
expression(bold(EC[bold("50")])~( bold(ppm))), y = expression(bold(EC[bold("50")~(bold("D"))])~( bold(ppm)))) + geom_abline(
                ...
                lty = "dashed",
                lwd = 1
                ) + expand_limits(x = c(0, 1.8), y = c(0, 1.8))+ scale_x_continuous(breaks = c(0.3,0.6, 0.9, 1.2, 1.5, 1.8))+ scale_y_continuous(breaks = c(0.3,0.6, 0.9, 1.2, 1.5, 1.8))
fig.1.tetraconazole                
fig.2.tetraconazole
```
