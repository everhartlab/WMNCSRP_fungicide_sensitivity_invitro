...
boscalid.xx <-
  ...
  # if they are in this group, that is named farmer fiels also ahead
  "survey_isolates",
  ...
  group = recode(
  group,
  survey_isolates = "Farmer fields",
  treatmentyear2016_isolates = "Fungicide field trials",
  baseline = "Baseline"
  )
...
```{r lineam model figures for publication}
fig.1.boscalid <-
