...
boscalid_data$ID <- as.character(boscalid_data$ID)
###
...
picoxystrobin_data$ID <- as.character(picoxystrobin_data$ID)
###
...
protozoa$ID <- as.character(protozoa$ID)
...
tetraconazole_data <- survey_data %>%
  ...
  tetraconazole_data$ID <- as.character(tetraconazole_data$ID)
###
...
boscalid_complete$ID <- as.character(boscalid_complete$ID)
#Replacing the ID from the inventory ID
 boscalid_complete$ID[ boscalid_complete$ID =="12B"]  <- "12"
 boscalid_complete$ID[ boscalid_complete$ID=="318"]  <- "2390"
 boscalid_complete$ID[ boscalid_complete$ID =="413"]  <- "2386"
 boscalid_complete$ID[ boscalid_complete$ID =="419"]  <- "2385"
  boscalid_complete$ID[ boscalid_complete$ID == "62-01"] <- "2097"  
  boscalid_complete$ID[ boscalid_complete$ID == "62-02"] <- "2098"
   boscalid_complete$ID[ boscalid_complete$ID == "62-03"] <- "2099"
    boscalid_complete$ID[ boscalid_complete$ID == "62-04"] <- "2100"
 #boscalid_complete[ boscalid_complete$ID =="74SS1"]  <- "74"

 boscalid_complete$ID[ boscalid_complete$ID == "78-01"] <- "2139"
  boscalid_complete$ID[ boscalid_complete$ID == "78-02"] <- "2140"


 boscalid_complete$ID[ boscalid_complete$ID == "78-05"]  <- "2143"
 
 boscalid_complete$ID[ boscalid_complete$ID == "H-01"]  <- "2220"
 boscalid_complete$ID[ boscalid_complete$ID == "H-03"] <- "2222"

  boscalid_complete$ID[ boscalid_complete$ID == "I-20"] <- "2362"
     boscalid_complete$ID[ boscalid_complete$ID =="W212"]  <- "2388"

  
  boscalid_complete$ID[ boscalid_complete$ID == "51C"] <- "2449"
 boscalid_complete$ID[ boscalid_complete$ID == "53B"] <- "2536"
boscalid_complete$ID[ boscalid_complete$ID == "54C"] <- "2453"
boscalid_complete$ID[ boscalid_complete$ID == "60A"] <- "2559"

boscalid_complete$ID[ boscalid_complete$ID == "64D"] <- "2518"
 boscalid_complete$ID[ boscalid_complete$ID == "65B"]  <- "2528"
 boscalid_complete$ID[ boscalid_complete$ID == "71B"] <-
"2505"

 
 boscalid_complete$ID[ boscalid_complete$ID == "S-01"] <- "2320"
